...
app = Flask(__name__)
camera = cv2.VideoCapture('/dev/video1', cv2.CAP_V4L2) # веб камера
...
def getFramesGenerator():
    ...
    while True:
        ...
        if success:
            frame = cv2.resize(frame, (1024, 768), interpolation=cv2.INTER_AREA)  # уменьшаем разрешение кадров (если видео тупит, можно уменьшить еще больше)
...
if __name__ == '__main__':
    ...
    parser.add_argument("-i", "--ip", type=str, default='10.1.10.160', help="Ip address")
